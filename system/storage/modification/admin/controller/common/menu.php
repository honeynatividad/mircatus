...
class ControllerCommonMenu extends Controller {
	public function index() {
		$this->load->language('common/menu');
			...
			$data['testimonial'] = $this->url->link('catalog/boss_testimonial', 'token=' . $this->session->data['token'], true);
...
$data['seller_product'] = $this->url->link('seller/product', 'token=' . $this->session->data['token'], 'SSL');
...
$data['text_seller_setting'] = $this->language->get('text_seller_setting');
$data['seller_setting'] = $this->url->link('seller/setting', 'token=' . $this->session->data['token'], 'SSL');
